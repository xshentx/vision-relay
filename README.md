...
bash ./tools/build-macos.sh --version v2.3.2.1 --arch arm64
```
...
```powershell
.\tools\build-windows.ps1 -Version v2.3.2.1
```
...
```bash
bash ./tools/build-macos.sh --version v2.3.2.1 --arch universal
```
