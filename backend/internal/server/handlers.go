...
func (a *app) handleOpenAIChat(w http.ResponseWriter, r *http.Request) {
	...
	writeUnexpectedStreamingResponse(w, resp, "OpenAI Chat Completions SSE")
}
...
func (a *app) handleOpenAIResponses(w http.ResponseWriter, r *http.Request) {
	...
	writeUnexpectedStreamingResponse(w, resp, "OpenAI Responses SSE")
}
...
func (a *app) handleAnthropicMessages(w http.ResponseWriter, r *http.Request) {
	...
	writeUnexpectedStreamingResponse(w, resp, "Anthropic Messages SSE")
}
...
func (a *app) handleGeminiGenerate(w http.ResponseWriter, r *http.Request) {
	...
	if isEventStreamResponse(resp) || (isSuccessfulResponse(resp) && !sse && responseStartsWithJSONArray(resp)) {
		keepStreamAfterHeaders()
		writeUpstream(w, resp)
		return
	}
	...
	writeUnexpectedStreamingResponse(w, resp, "Gemini streamGenerateContent stream")
}
...
func (a *app) handleOllamaChat(w http.ResponseWriter, r *http.Request) {
	...
	a.forwardOllama(w, r, cfg, payload, out)
}
...
func (a *app) forwardOllama(w http.ResponseWriter, r *http.Request, cfg config, payload map[string]any, out []byte) {
	...
	writeUnexpectedStreamingResponse(w, resp, "Ollama NDJSON stream")
}
